...
def saveRes(sts):
    print("saving nparray-" +str(sts))
    np.save("nparray-" + str(sts),accel[3])

kb.on_press_key("q", lambda _:saveRes(1))
kb.on_press_key("w", lambda _:saveRes(2))
kb.on_press_key("e", lambda _:saveRes(3))
kb.on_press_key("r", lambda _:saveRes(4))
